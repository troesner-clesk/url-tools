...
describe('isInternalLink', () => {
  it('identifies internal links', () => {
    expect(
      isInternalLink('https://example.com', 'https://example.com/page'),
    ).toBe(true)
    expect(
      isInternalLink('https://example.com/a', 'https://example.com/b'),
    ).toBe(true)
  })

  it('identifies external links', () => {
    expect(
      isInternalLink('https://example.com', 'https://other.com/page'),
    ).toBe(false)
  })
